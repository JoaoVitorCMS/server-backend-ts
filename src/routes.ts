...
const routes = Router();
import listControllers from "./controllers/list";
//rota de teste
...
routes.post("/list", (req: Request, res: Response) : any => listControllers.create(req, res))
routes.get("/list", (req: Request, res: Response) : any => listControllers.read(req, res))
routes.put("/list/:id", (req: Request, res: Response) : any => listControllers.update(req, res))
routes.delete("/list/:id", (req: Request, res: Response) : any => listControllers.delete(req,res))
